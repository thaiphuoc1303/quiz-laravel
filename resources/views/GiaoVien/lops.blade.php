    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header" style="display: flex;">
                ...
                Lớp
                <div style="margin-left: 30%"><a href="{{ URL::asset('giao-vien/themlop') }}"
                        class="btn btn-sm btn-success">Thêm lớp</a></div>
            </div>
            <div class="card-body">
                        ...
                        <table id="datatablesSimple" class="dataTable-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">Số
                                            lượng</a></th>
                                    {{-- <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">Số
                                            buổi</a></th> --}}
                                    <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">Danh
                                            sách</a></th>
                            ...
                            <tbody>
                                ...
                                @foreach ($lops as $item)
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>{{ $item->ten }}</td>
                                        <td>{{ $item->sohocsinh }}</td>
                                        {{-- <td>{{ $item->sobuoidahoc }}
                                            <a href="{{ URL::asset('giao-vien/cong1') }}/{{ $item->id }}"
                                                style="margin-left: 30%" class=" btn btn-sm btn-primary">+1</a>
                                        </td> --}}
                                        <td>
                                            <a href="{{ URL::asset('giao-vien/danhsachlop') }}/{{ $item->id }}"
                                                class="btn btn-sm btn-info">Học sinh</a>
                                            <a href="{{ URL::asset('giao-vien/dedagiao') }}/{{ $item->id }}"
                                                class="btn btn-sm btn-warning">Bài làm</a>
                                        </td>
                                        <td>
                                            <a href="{{ URL::asset('giao-vien/sualop') }}/{{ $item->id }}"
                                                class="btn btn-sm btn-success">Sửa</a>
                                            <a href="{{ URL::asset('giao-vien/xoalop') }}/{{ $item->id }}"
