                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                @php
                                    $bailam = App\Models\bailam::where('id_hs', $hocsinh->id)->where('de', $item->id)->first();
                                @endphp
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $item->ten }}</h6>
                                        ...
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{$item->ngaygiao}}</p>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $item->hannop }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <a href="{{URL::asset('hoc-sinh/lambai')}}/{{$item->id}}" class="badge badge-sm bg-gradient-info">Chưa làm</a>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            {{isset($bailam) ? $bailam->diem : ''}}
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <a href="{{URL::asset('hoc-sinh/lambai')}}/{{$item->id}}" class="badge badge-sm bg-gradient-success">Hoàn thành</a>
