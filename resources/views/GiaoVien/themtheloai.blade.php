...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <form action="{{ URL::asset('giao-vien/posttheloai') }}" style="padding: 2%" method="POST">
                @csrf
                <div class="row g-2">
                    <div class="col-md-2">
                        Khối
                        <select class="form-select" id="khoi" onchange="loadtl()" name="khoi">
                    ...
                    <div class="col-md-3">
                        Chương
                        <select name="chuong" id="chuong" class="form-select">
                ...
                <hr>
                    <input type="text" name="ten" class="form-control" placeholder="Tên Bài">
    ...
    <script>
        function loadtl() {
            ...
            var u = "{{ URL::asset('giao-vien/loadtheloai') }}/" + id;
            $.ajax({
                type: 'GET',
                url: u,
