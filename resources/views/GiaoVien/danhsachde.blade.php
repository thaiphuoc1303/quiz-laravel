...
@section('content')
        ...
        <div class="row">
            <div class="card mb-4">
                <div class="card-header" style="display: flex;">
                    ...
                    {{ isset($title_table) ? $title_table : '' }}
                    <div style="margin-left: 30%"><a href="{{ URL::asset('giao-vien/themdebai') }}"
                            class="btn btn-sm btn-success">Thêm đề bài</a></div>
                </div>
                <div class="card-body">
                            ...
                            <table id="datatablesSimple" class="dataTable-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-sortable="" style="width: 40%;"><a href="#" class="dataTable-sorter">Tên đề
                                                bài</a>
                                        </th>
                                        <th data-sortable="" style="width: 10%;"><a href="#"
                                                class="dataTable-sorter">Level</a></th>
                                        <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">Thời
                                                gian</a></th>
                                        <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">Lượt
                                                làm</a></th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($debais as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->thoigian }}</td>
                                            <td>{{ $item->luotlam }}</td>
                                            <td><a href="{{ URL::asset('giao-vien/debai/chitiet') }}/{{$item->id}}" class="btn btn-sm btn-info">Chi tiết</a></td>
                                            <td>
                                                <a href="{{ URL::asset('giao-vien/debai') }}/{{ $item->id }}/all"
    ...
    <script type="text/javascript">
        function ConfirmDialog(id) {
            ...
            if (result) {
                window.location.href = "{{ URL::asset('giao-vien/xoadebai') }}/" + id;
                alert('Đã xóa');
            }
        }
    </script>
